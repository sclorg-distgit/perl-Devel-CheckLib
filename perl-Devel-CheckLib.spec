%{?scl:%scl_package perl-Devel-CheckLib}

Name:           %{?scl_prefix}perl-Devel-CheckLib
Version:        1.14
Release:        2%{?dist}
...
BuildRequires:  %{?scl_prefix}perl(Capture::Tiny)
BuildRequires:  %{?scl_prefix}perl(lib)
BuildRequires:  %{?scl_prefix}perl(Test::More) >= 0.88
# Optional tests
%if ! (0%{?scl:1})
BuildRequires:  %{?scl_prefix}perl(Mock::Config)
%endif
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 1.14-2
- SCL
